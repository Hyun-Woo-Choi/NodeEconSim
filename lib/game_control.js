...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    const cal_round = async function (room_number, user_round, admin_round, user_submit_list, io) {
        ...
        try {
            ...
            if (io.user_2_socket_id && io.user_2_socket_id['admin']) {
                io.message(io.user_2_socket_id['admin'], 'cal_round_error', { 
                    room_number: room_number,
                    round: user_round,
                    admin_round : admin_round,
                    user : user_submit_list,
                    error: err.message || 'Unknown error occurred in cal_round'
                });
                console.log(`Error notification sent to admin for room ${room_number}, round ${user_round}`);
            } else {
                console.warn('Admin socket ID not found. Cannot send error notification.');
            }
